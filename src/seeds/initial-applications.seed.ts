    ...
    const applications = [
      ...
      // InOut
      {
        ...
        roles: [
          ...
          {
            strName: 'operatorInout',
            strDescription1: 'Operador',
            strDescription2: 'Puede registrar ventas, producción, entradas/salidas. No puede eliminar ni configurar.',
            menuOptions: [
              { strName: 'dashboardOperatorInout', strDescription: 'Inicio', strUrl: '/home', strIcon: 'house', strType: 'main_menu', ingOrder: 1 },
              { strName: 'materialsOperatorInout', strDescription: 'Materiales', strUrl: '/materials', strIcon: 'box-seam', strType: 'main_menu', ingOrder: 2 },
              { strName: 'productsOperatorInout', strDescription: 'Productos', strUrl: '/products', strIcon: 'box', strType: 'main_menu', ingOrder: 3 },
              { strName: 'commercialOperatorInout', strDescription: 'Comercial', strUrl: '/commercial', strIcon: 'shop', strType: 'main_menu', ingOrder: 4 },
            ],
          },
          {
            strName: 'viewerInout',
            strDescription1: 'Visor',
            strDescription2: 'Acceso solo lectura al panel, inventario y reportes.',
            menuOptions: [
              { strName: 'dashboardViewerInout', strDescription: 'Inicio', strUrl: '/home', strIcon: 'house', strType: 'main_menu', ingOrder: 1 },
              { strName: 'materialsViewerInout', strDescription: 'Materiales', strUrl: '/materials', strIcon: 'box-seam', strType: 'main_menu', ingOrder: 2 },
      ...
      {
        strName: 'Kiri',
        strDescription: 'Personal Finance Management - Kiri Finance',
        strUrlImage: 'https://res.cloudinary.com/dn8ki4idz/image/upload/v1784779804/logo_kiri.png',
        strSlug: 'kiri app',
        strTags: ['finance', 'personal', 'savings', 'debts', 'budget'],
        roles: [
          {
            strName: 'adminKiri',
            strDescription1: 'Administrator',
            strDescription2: 'Full access to Kiri Finance',
            menuOptions: [
              {
                strName: 'homeKiri',
                strDescription: 'Home',
          ...
          {
            strName: 'userKiri',
            strDescription1: 'User',
            strDescription2: 'Basic access to Kiri Finance',
            menuOptions: [
              {
                strName: 'homeKiriUser',
                strDescription: 'Home',
                strUrl: '/home',
                strIcon: 'house',
                strType: 'main_menu',
        ...
        roles: [
          {
            strName: 'adminShotra',
            strDescription1: 'Administrator',
            strDescription2: 'Full access to Shotra marketplace',
            menuOptions: [
              {
                strName: 'homeShotra',
                strDescription: 'Home',
              ...
              {
                strName: 'requestsShotra',
                strDescription: 'Solicitudes',
                strUrl: '/requests',
                strIcon: 'list-task',
                strType: 'main_menu',
                ingOrder: 2,
              ...
              {
                strName: 'proposalsShotra',
                strDescription: 'Propuestas',
                strUrl: '/proposals',
                strIcon: 'chat-left-text',
                strType: 'main_menu',
                ingOrder: 3,
              },
              {
                strName: 'contractsShotra',
                strDescription: 'Contratos',
                strUrl: '/contracts',
                strIcon: 'file-earmark-check',
                strType: 'main_menu',
                ingOrder: 4,
              },
              {
                strName: 'profileShotra',
                strDescription: 'Perfil',
                strUrl: '/profile',
                strIcon: 'person',
                strType: 'main_menu',
                ingOrder: 5,
          ...
          },
          {
            strName: 'userShotra',
            strDescription1: 'User',
            strDescription2: 'Basic access to Shotra marketplace',
            menuOptions: [
              {
                strName: 'feedShotraUser',
                strDescription: 'Explorar',
                strUrl: '/feed',
                strIcon: 'search',
                strType: 'main_menu',
